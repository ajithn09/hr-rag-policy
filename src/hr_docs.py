"""
Realistic HR policy documents for AskHR.
...
HR_DOCUMENTS = [
    {
        ...
        "content": """
Annual Leave & Time Off Policy — AskHR
...
REQUESTING VACATION
All vacation requests must be submitted through the HR portal (hr.AskHRcorp.com) at least 10 business days in advance.
...
""".strip()
    },
    {
        ...
        "content": """
Remote Work & Hybrid Policy — AskHR

OVERVIEW
AskHR supports hybrid and remote work arrangements that balance flexibility with collaboration.
...
AskHR provides a one-time home office setup allowance of $600 for eligible equipment (receipts required).
...
""".strip()
    },
    {
        ...
        "content": """
Code of Conduct — AskHR

PURPOSE
This Code sets the standard of professional behaviour expected of all AskHR employees,
...
Represent AskHR professionally at client sites, events, and online.
Treat all colleagues, clients, vendors, and partners with courtesy and dignity.

CONFLICTS OF INTEREST
Disclose in writing to HR any situation where personal interests may conflict with AskHR's interests.
...
CONFIDENTIALITY
Protect all AskHR confidential information: business plans, customer data, financial results, source code, and personnel records.
...
When posting as an AskHR employee, add: "Views are my own, not AskHR's."
...
Report concerns to your manager, HR, or anonymously via ethics@AskHRcorp.com.
...
""".strip()
    },
    {
        ...
        "content": """
Performance Review Process — AskHR
...
""".strip()
    },
    {
        ...
        "content": """
Benefits & Compensation Overview — AskHR

COMPENSATION PHILOSOPHY
AskHR benchmarks salaries at the 65th percentile of market rates for equivalent roles.
...
Medical: AskHR covers 80% of the premium for employee-only plans; 60% for family plans.
...
AskHR matches 100% on the first 2% of salary contributed, plus 50% on the next 2%.
...
Access via eap.AskHRcorp.com or call 1-800-EAP-HELP.
...
""".strip()
    },
    {
        ...
        "content": """
Anti-Harassment & Discrimination Policy — AskHR

ZERO TOLERANCE
AskHR is committed to a workplace free from harassment, discrimination, and retaliation.
...
Contact HR directly at hr@AskHRcorp.com or by phone at +1-415-555-0199.
Report anonymously via the Ethics Hotline: ethics@AskHRcorp.com or 1-800-555-ETHICS.
...
AskHR reserves the right to pursue civil or criminal action where appropriate.
""".strip()
    },
]
